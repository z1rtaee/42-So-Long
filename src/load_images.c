...
/*   Updated: 2025/04/30 13:46:17 by bpires-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_player_1(t_solong *data)
{
	...
	data->tile_frame.player.down_1[0].data = mlx_get_data_addr(data->tile_frame.player.down_1[0].image,
			&data->tile_frame.player.down_1[0].bpp,
			&data->tile_frame.player.down_1[0].size_line,
			&data->tile_frame.player.down_1[0].type);
	data->tile_frame.player.down_1[1].data = mlx_get_data_addr(data->tile_frame.player.down_1[1].image,
			&data->tile_frame.player.down_1[1].bpp,
			&data->tile_frame.player.down_1[1].size_line,
			&data->tile_frame.player.down_1[1].type);
	data->tile_frame.player.down_1[2].data = mlx_get_data_addr(data->tile_frame.player.down_1[2].image,
	...
	data->tile_frame.player.up_1[0].data = mlx_get_data_addr(data->tile_frame.player.up_1[0].image,
			&data->tile_frame.player.up_1[0].bpp,
			&data->tile_frame.player.up_1[0].size_line,
			&data->tile_frame.player.up_1[0].type);
	data->tile_frame.player.up_1[1].data = mlx_get_data_addr(data->tile_frame.player.up_1[1].image,
			&data->tile_frame.player.up_1[1].bpp,
			&data->tile_frame.player.up_1[1].size_line,
			&data->tile_frame.player.up_1[1].type);
	data->tile_frame.player.up_1[2].data = mlx_get_data_addr(data->tile_frame.player.up_1[2].image,
	...
	data->tile_frame.player.left_1[0].data = mlx_get_data_addr(data->tile_frame.player.left_1[0].image,
			&data->tile_frame.player.left_1[0].bpp,
			&data->tile_frame.player.left_1[0].size_line,
			&data->tile_frame.player.left_1[0].type);
	data->tile_frame.player.left_1[1].data = mlx_get_data_addr(data->tile_frame.player.left_1[1].image,
			&data->tile_frame.player.left_1[1].bpp,
			&data->tile_frame.player.left_1[1].size_line,
			&data->tile_frame.player.left_1[1].type);
	data->tile_frame.player.left_1[2].data = mlx_get_data_addr(data->tile_frame.player.left_1[2].image,
	...
	data->tile_frame.player.right_1[0].data = mlx_get_data_addr(data->tile_frame.player.right_1[0].image,
			&data->tile_frame.player.right_1[0].bpp,
			&data->tile_frame.player.right_1[0].size_line,
			&data->tile_frame.player.right_1[0].type);
	data->tile_frame.player.right_1[1].data = mlx_get_data_addr(data->tile_frame.player.right_1[1].image,
			&data->tile_frame.player.right_1[1].bpp,
			&data->tile_frame.player.right_1[1].size_line,
			&data->tile_frame.player.right_1[1].type);
	data->tile_frame.player.right_1[2].data = mlx_get_data_addr(data->tile_frame.player.right_1[2].image,
...
void	load_player_0(t_solong *data)
{
	...
	data->tile_frame.player.down_0[0].data = mlx_get_data_addr(data->tile_frame.player.down_0[0].image,
			&data->tile_frame.player.down_0[0].bpp,
			&data->tile_frame.player.down_0[0].size_line,
			&data->tile_frame.player.down_0[0].type);
	data->tile_frame.player.down_0[1].data = mlx_get_data_addr(data->tile_frame.player.down_0[1].image,
			&data->tile_frame.player.down_0[1].bpp,
			&data->tile_frame.player.down_0[1].size_line,
			&data->tile_frame.player.down_0[1].type);
	data->tile_frame.player.down_0[2].data = mlx_get_data_addr(data->tile_frame.player.down_0[2].image,
	...
	data->tile_frame.player.up_0[0].data = mlx_get_data_addr(data->tile_frame.player.up_0[0].image,
			&data->tile_frame.player.up_0[0].bpp,
			&data->tile_frame.player.up_0[0].size_line,
			&data->tile_frame.player.up_0[0].type);
	data->tile_frame.player.up_0[1].data = mlx_get_data_addr(data->tile_frame.player.up_0[1].image,
			&data->tile_frame.player.up_0[1].bpp,
			&data->tile_frame.player.up_0[1].size_line,
			&data->tile_frame.player.up_0[1].type);
	data->tile_frame.player.up_0[2].data = mlx_get_data_addr(data->tile_frame.player.up_0[2].image,
	...
	data->tile_frame.player.left_0[0].data = mlx_get_data_addr(data->tile_frame.player.left_0[0].image,
			&data->tile_frame.player.left_0[0].bpp,
			&data->tile_frame.player.left_0[0].size_line,
			&data->tile_frame.player.left_0[0].type);
	data->tile_frame.player.left_0[1].data = mlx_get_data_addr(data->tile_frame.player.left_0[1].image,
			&data->tile_frame.player.left_0[1].bpp,
			&data->tile_frame.player.left_0[1].size_line,
			&data->tile_frame.player.left_0[1].type);
	data->tile_frame.player.left_0[2].data = mlx_get_data_addr(data->tile_frame.player.left_0[2].image,
	...
	data->tile_frame.player.right_0[0].data = mlx_get_data_addr(data->tile_frame.player.right_0[0].image,
			&data->tile_frame.player.right_0[0].bpp,
			&data->tile_frame.player.right_0[0].size_line,
			&data->tile_frame.player.right_0[0].type);
	data->tile_frame.player.right_0[1].data = mlx_get_data_addr(data->tile_frame.player.right_0[1].image,
			&data->tile_frame.player.right_0[1].bpp,
			&data->tile_frame.player.right_0[1].size_line,
			&data->tile_frame.player.right_0[1].type);
	data->tile_frame.player.right_0[2].data = mlx_get_data_addr(data->tile_frame.player.right_0[2].image,
...
void	load_map(t_solong *data)
{
	...
	data->tile_frame.floor.data = mlx_get_data_addr(data->tile_frame.floor.image,
	...
	data->tile_frame.enemy.data = mlx_get_data_addr(data->tile_frame.enemy.image,
	...
	data->tile_frame.exit.data = mlx_get_data_addr(data->tile_frame.exit.image,
...
{
	data->tile_frame.c1[0].data = mlx_get_data_addr(data->tile_frame.c1[0].image,
...
void	load_menu_select(t_solong *data)
{
	...
	data->menu.credits_menu.data = mlx_get_data_addr(data->menu.credits_menu.image,
