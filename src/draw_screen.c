...
/*   Updated: 2025/04/23 18:42:00 by bpires-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_player_0(t_solong *data)
{
	...
	if (data->keys.a)
		put_img_to_screen(&data->final_screen, data->tile_frame.player.left_0[frame], data->player.pos_x, data->player.pos_y + 16);
	else if (data->keys.w)
		put_img_to_screen(&data->final_screen, data->tile_frame.player.up_0[frame], data->player.pos_x, data->player.pos_y + 16);
	else if (data->keys.s)
		put_img_to_screen(&data->final_screen, data->tile_frame.player.down_0[frame], data->player.pos_x, data->player.pos_y + 16);
	else if (data->keys.d)
		put_img_to_screen(&data->final_screen, data->tile_frame.player.right_0[frame], data->player.pos_x, data->player.pos_y + 16);
	else
...
void	draw_player_1(t_solong *data)
{
	...
	frame = ((frame - 3) * FRAME_TIME) / (FPS / 3);
	if (data->keys.a)
		put_img_to_screen(&data->final_screen, data->tile_frame.player.left_1[frame], data->player.pos_x, data->player.pos_y + 16);
	else if (data->keys.w)
		put_img_to_screen(&data->final_screen, data->tile_frame.player.up_1[frame], data->player.pos_x, data->player.pos_y + 16);
	else if (data->keys.s)
		put_img_to_screen(&data->final_screen, data->tile_frame.player.down_1[frame], data->player.pos_x, data->player.pos_y + 16);
	else if (data->keys.d)
		put_img_to_screen(&data->final_screen, data->tile_frame.player.right_1[frame], data->player.pos_x, data->player.pos_y + 16);
	else
